  ...
  return (
    <div className="relative w-full">
      <select
        ...
        className={cn(
          "w-full h-auto px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent cursor-pointer",
          className
        )}
      >
